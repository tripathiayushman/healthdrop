...
// NOTE: alert push fan-out is handled entirely server-side by the
// trg_push_on_alert_created trigger -> notify_users_push -> push-notifications
// edge function pipeline. The former client-side sendAlertPushNotifications
// was removed: profiles RLS prevents most roles from enumerating push tokens,
// and admin-side sends double-notified recipients alongside the DB trigger.
